...
if (!class_exists('WooDeliverablesUtils')) {
    class WooDeliverablesUtils
    {

        public function enqueue_style($name, $src = '', $deps = array(), $ver = WOODELIVERABLES_VERSION, $media = 'all')
        {
            $handle = "store-slots-" . $name;
            $src = WOODELIVERABLES_CSS_DIR . $src;
        ...
        public function enqueue_script($name, $src = '', $deps = array(), $ver = WOODELIVERABLES_VERSION, $in_footer = false)
        {
            $handle = "store-slots-" . $name;
            $src = WOODELIVERABLES_JS_DIR . $src;
            _wp_scripts_maybe_doing_it_wrong(__FUNCTION__, $handle);
         ...
         */
        public function get_store_sloat_time_zones($timezone = ''){
                ...
                foreach( $timezones as $key => $val ){
                    if( is_array( $val ) ){
                        ...
                        foreach( $val as $k => $row ){
                            $selected = !empty($timezone) && $timezone == $k ? 'selected' : '';
                            $options .= '<option '. $selected .' value="'. $k .'">' . $row . '</option>';
                        }
                        $options .= '</optgroup>';
                    }
                }
